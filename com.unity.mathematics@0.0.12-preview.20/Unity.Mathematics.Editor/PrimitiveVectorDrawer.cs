...
namespace Unity.Mathematics.Editor
{
    ...
    class PrimitiveVectorDrawer : PropertyDrawer
    {
        ...
        {
            public static readonly string doNotNormalizeCompatibility = L10n.Tr(string.Format("{0} only works with {1} and primitive vector types.", typeof(PostNormalizeAttribute).Name, typeof(quaternion)));
