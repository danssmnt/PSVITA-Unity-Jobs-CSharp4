...
namespace Unity.Mathematics
{
    ...
    public partial struct Random
    {
        ...
        {
            return math.asfloat(0x3f800000 | (new uint2(NextState(), NextState()) >> 9)) - 1.0f;
        }
        ...
        {
            return math.asfloat(0x3f800000 | (new uint3(NextState(), NextState(), NextState()) >> 9)) - 1.0f;
        }
        ...
        {
            return math.asfloat(0x3f800000 | (new uint4(NextState(), NextState(), NextState(), NextState()) >> 9)) - 1.0f;
        }
        ...
        public double2 NextDouble2()
        {
            ...
            return new double2(math.asdouble(0x3ff0000000000000 | sx),
        ...
        public double3 NextDouble3()
        {
            ...
            return new double3(math.asdouble(0x3ff0000000000000 | sx),
        ...
        public double4 NextDouble4()
        {
            ...
            return new double4(math.asdouble(0x3ff0000000000000 | sx),
                           math.asdouble(0x3ff0000000000000 | sy),
        ...
        {
            float angle = NextFloat() * (float)math.PI * 2.0f;
            float s, c;
        ...
        public float3 NextFloat3Direction()
        {
            ...
            float angle = rnd.y * (float)math.PI * 2.0f;
            float s, c;
            math.sincos(angle, out s, out c);
        ...
        public double3 NextDouble3Direction()
        {
            ...
            double angle = rnd.y * math.PI * 2.0;
            double s, c;
            math.sincos(angle, out s, out c);
        ...
        {
            float3 rnd = NextFloat3(new float3(2.0f * (float)math.PI, 2.0f * (float)math.PI, 1.0f));
            float u1 = rnd.z;
